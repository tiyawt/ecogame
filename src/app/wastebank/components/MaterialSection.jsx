    ...
    <section className="mt-6 rounded-2xl border border-slate-200 bg-white px-4 py-4 text-slate-800">
      ...
      <div className="mt-4 flex flex-col sm:flex-row sm:items-center gap-3">
        ...
        <button
          ...
          className="rounded-xl bg-emerald-600 text-white px-4 py-2 text-sm font-medium hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
        >
          Lanjut
        </button>
      </div>
